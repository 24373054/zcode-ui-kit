...
- `@zcode-ui/tokens@1.0.0` — 设计令牌 CSS
- `@zcode-ui/theme@1.0.0` — 主题运行时
- `@zcode-ui/core@1.0.0` — shadcn 风格基础组件
- `@zcode-ui/ai-elements@1.0.0` — AI 对话/工具 UI 元素（新）

### 亮点

- 新增 `@zcode-ui/ai-elements`：code-block（独立 shiki）、sources、confirmation、tool、task、prompt-input、conversation、persona 等
...
- 从 `@zcode-ui/core` 导入 `shimmer` / `suggestion` / `snippet` 需改为 `@zcode-ui/ai-elements/*`
...
- Packages: `@zcode-ui/tokens`, `@zcode-ui/theme`, `@zcode-ui/core`, **new** `@zcode-ui/ai-elements`
